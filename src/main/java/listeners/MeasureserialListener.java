...
public class MeasureserialListener
  implements ActionListener
{
  ...
  public void actionPerformed(ActionEvent arg0) {
    ...
    parent.Panelfile.add(parent.scrollPane, new GridBagConstraints(0, 1, 1, 1, 0.0D, 0.0D, 17, 
      2, InteractiveChirpFit.insets, 0, 0));
    parent.Panelfile.add(parent.AutoFit, new GridBagConstraints(0, 2, 1, 1, 0.0D, 0.0D, 17, 
      2, InteractiveChirpFit.insets, 0, 0));
    parent.Panelfile.add(parent.inputLabelBins, new GridBagConstraints(0, 3, 1, 1, 0.0D, 0.0D, 17, 
      2, InteractiveChirpFit.insets, 0, 0));
    parent.Panelfile.add(parent.inputFieldBins, new GridBagConstraints(0, 4, 1, 1, 0.0D, 0.0D, 17, 
      2, InteractiveChirpFit.insets, 0, 0));
    parent.Panelfile.add(parent.Frequhist, new GridBagConstraints(0, 5, 1, 1, 0.0D, 0.0D, 17, 
      2, InteractiveChirpFit.insets, 0, 0));
    parent.Panelfile.setBorder(parent.selectfile);
    parent.panelFirst.add(parent.Panelfile, new GridBagConstraints(1, 3, 3, 1, 0.0D, 0.0D, 17, 
